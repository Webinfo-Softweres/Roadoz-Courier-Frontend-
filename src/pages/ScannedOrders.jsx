      ...
      {isScanning && (
        <Card className="border-2 border-primary border-dashed bg-black overflow-hidden relative">
          <CardContent className="p-0 flex flex-col items-center">
            <div id="reader" className="w-full max-w-lg aspect-video md:aspect-[16/9]"></div>
                ...
                {orders.length > 0 ? (
                  orders.map((order) => (
                    <tr key={order.id} className="hover:bg-primary/5 transition-all group">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase flex items-center w-fit gap-1.5 ${
